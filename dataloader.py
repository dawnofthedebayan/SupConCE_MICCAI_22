...
class ParanasalContrastiveDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_cls_1 = tio.SubjectsDataset(self.subjects["train_cls_1"], transform=self.transform)
        self.train_cls_2 = tio.SubjectsDataset(self.subjects["train_cls_2"], transform=self.transform)
